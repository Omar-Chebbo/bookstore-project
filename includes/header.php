<?php 
    ...
    define("APPURL", "https://bookstore.kesug.com/I439-Project");
    //URL for the images
    define("IMGURL","https://bookstore.kesug.com/I439-Project/admin-panel/products-admins/images");
    //if i use require it will make error so i use this
    require dirname(dirname(__FILE__))."/config/config.php";

    //to get how item this user have and show it beside cart icon
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="margin-top: none">
        <a class="navbar-brand  text-white" href="<?php echo APPURL; ?>/">Bookstore</a> <!-- Add a / after the APPURL so the url is correct -->
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <?php 
            // if i am logged in so i will show this cart  in header
            if(isset($_SESSION['username'])) : ?>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="<?php echo APPURL; ?>/users/settings.php">Settings</a></li>
            ...
            <?php 
            //if i am not logged in i will show this
            else :?>
                    <li class="nav-item">
