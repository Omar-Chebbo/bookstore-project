...
<div class="row mt-5">
        ...
        <div class="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h5 class="d-inline">
                        <div class="text-muted d-inline"><?php echo $product->pro_price; ?></div>
                    </h5>
    ...
    <?php endforeach; ?>
    <?php else:?>
      <div class="alert alert-success text-white bg-success">there is no items in your wishlist</div>
      <?php endif?>
</div>
